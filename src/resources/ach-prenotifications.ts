...
export class ACHPrenotifications extends APIResource {
   ...
   * ```
   */
  list(query: ACHPrenotificationListParams | null | undefined = {}, options?: RequestOptions): PagePromise<ACHPrenotificationsPage, ACHPrenotification> {
...
export interface ACHPrenotification {
   ...
   */
  standard_entry_class_code: 'corporate_credit_or_debit' | 'corporate_trade_exchange' | 'prearranged_payments_and_deposit' | 'internet_initiated' | null;
