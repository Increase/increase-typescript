...
export class FednowTransfers extends APIResource {
   ...
   * ```
   */
  list(query: FednowTransferListParams | null | undefined = {}, options?: RequestOptions): PagePromise<FednowTransfersPage, FednowTransfer> {
...
export interface FednowTransfer {
   ...
   */
  status: 'pending_submitting' | 'pending_reviewing' | 'canceled' | 'reviewing_rejected' | 'requires_attention' | 'pending_approval' | 'pending_response' | 'complete' | 'rejected';
...
export namespace FednowTransferListParams {
  ...
  export interface Status {
     ...
     */
    in?: Array<'pending_submitting' | 'pending_reviewing' | 'canceled' | 'reviewing_rejected' | 'requires_attention' | 'pending_approval' | 'pending_response' | 'complete' | 'rejected'>;
  }
}
