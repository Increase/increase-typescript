    ...
    export namespace CardRefund {
      ...
      export namespace PurchaseDetails {
        ...
        export interface Fleet {
           ...
           */
          service_type: 'full_service' | 'self_service' | null;
