...
import * as CardPushTransfersAPI from './card-push-transfers';
...
export class CardPushTransfers extends APIResource {
   ...
   * ```
   */
  list(query: CardPushTransferListParams | null | undefined = {}, options?: RequestOptions): PagePromise<CardPushTransfersPage, CardPushTransfer> {
...
export interface CardPushTransfer {
   ...
   */
  status: 'pending_approval' | 'canceled' | 'pending_submission' | 'pending_reviewing' | 'requires_attention' | 'submitted' | 'complete' | 'declined';
...
export namespace CardPushTransferListParams {
  ...
  export interface Status {
     ...
     */
    in?: Array<'pending_approval' | 'canceled' | 'pending_submission' | 'pending_reviewing' | 'requires_attention' | 'submitted' | 'complete' | 'declined'>;
  }
}
