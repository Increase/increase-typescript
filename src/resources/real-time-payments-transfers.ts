...
export interface RealTimePaymentsTransfer {
   ...
   */
  status: 'pending_approval' | 'canceled' | 'pending_submission' | 'pending_reviewing' | 'requires_attention' | 'rejected' | 'submitted' | 'complete';
...
export namespace RealTimePaymentsTransferListParams {
  ...
  export interface Status {
     ...
     */
    in?: Array<'pending_approval' | 'canceled' | 'pending_submission' | 'pending_reviewing' | 'requires_attention' | 'rejected' | 'submitted' | 'complete'>;
  }
}
