...
export class EventSubscriptions extends APIResource {
   ...
   * ```
   */
  update(eventSubscriptionID: string, body: EventSubscriptionUpdateParams, options?: RequestOptions): APIPromise<EventSubscription> {
   ...
   * ```
   */
  list(query: EventSubscriptionListParams | null | undefined = {}, options?: RequestOptions): PagePromise<EventSubscriptionsPage, EventSubscription> {
...
export interface EventSubscription {
   ...
   * specified `category`.
   */
  selected_event_categories: Array<EventSubscription.SelectedEventCategory> | null;
...
export namespace EventSubscription {
  export interface SelectedEventCategory {
    /**
...
export interface EventSubscriptionCreateParams {
   ...
   */
  selected_event_categories?: Array<EventSubscriptionCreateParams.SelectedEventCategory>;
...
export namespace EventSubscriptionCreateParams {
  export interface SelectedEventCategory {
    /**
