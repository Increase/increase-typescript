...
describe('resource realTimePaymentsTransfers', () => {
  ...
  test('retrieve', async () => {
    const responsePromise = client.realTimePaymentsTransfers.retrieve('real_time_payments_transfer_iyuhl5kdn7ssmup83mvq');
    const rawResponse = await responsePromise.asResponse();
    expect(rawResponse).toBeInstanceOf(Response);
    const response = await responsePromise;
    expect(response).not.toBeInstanceOf(Response);
  ...
  test('list: request options and params are passed correctly', async () => {
    ...
    await expect(client.realTimePaymentsTransfers.list({
  ...
  test('approve', async () => {
    const responsePromise = client.realTimePaymentsTransfers.approve('real_time_payments_transfer_iyuhl5kdn7ssmup83mvq');
    const rawResponse = await responsePromise.asResponse();
    expect(rawResponse).toBeInstanceOf(Response);
    const response = await responsePromise;
    expect(response).not.toBeInstanceOf(Response);
  ...
  test('cancel', async () => {
    const responsePromise = client.realTimePaymentsTransfers.cancel('real_time_payments_transfer_iyuhl5kdn7ssmup83mvq');
    const rawResponse = await responsePromise.asResponse();
    expect(rawResponse).toBeInstanceOf(Response);
    const response = await responsePromise;
    expect(response).not.toBeInstanceOf(Response);
