...
describe('resource accountRevenuePayments', () => {
  test('create: only required params', async () => {
    const responsePromise = client.simulations.accountRevenuePayments.create({ account_id: 'account_in71c4amph0vgo2qllky', amount: 1000 });
  ...
  test('create: required and optional params', async () => {
    const response = await client.simulations.accountRevenuePayments.create({
