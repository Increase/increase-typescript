...
describe('resource eventSubscriptions', () => {
  ...
  test('retrieve', async () => {
    const responsePromise = client.eventSubscriptions.retrieve('event_subscription_001dzz0r20rcdxgb013zqb8m04g');
    const rawResponse = await responsePromise.asResponse();
    expect(rawResponse).toBeInstanceOf(Response);
    const response = await responsePromise;
    expect(response).not.toBeInstanceOf(Response);
  ...
  test('update', async () => {
    const responsePromise = client.eventSubscriptions.update('event_subscription_001dzz0r20rcdxgb013zqb8m04g', {});
    const rawResponse = await responsePromise.asResponse();
    expect(rawResponse).toBeInstanceOf(Response);
    const response = await responsePromise;
    expect(response).not.toBeInstanceOf(Response);
  ...
  test('list: request options and params are passed correctly', async () => {
    ...
    await expect(client.eventSubscriptions.list({
    cursor: 'cursor',
    idempotency_key: 'x',
    limit: 1,
