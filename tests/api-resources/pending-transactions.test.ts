...
describe('resource pendingTransactions', () => {
  test('create: only required params', async () => {
    const responsePromise = client.pendingTransactions.create({ account_id: 'account_in71c4amph0vgo2qllky', amount: -1000 });
  ...
  test('list: request options and params are passed correctly', async () => {
    ...
    await expect(client.pendingTransactions.list({
