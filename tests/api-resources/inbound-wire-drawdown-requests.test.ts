...
describe('resource inboundWireDrawdownRequests', () => {
  test('retrieve', async () => {
    const responsePromise = client.inboundWireDrawdownRequests.retrieve('inbound_wire_drawdown_request_u5a92ikqhz1ytphn799e');
  ...
  test('list: request options and params are passed correctly', async () => {
    ...
    await expect(client.inboundWireDrawdownRequests.list({ cursor: 'cursor', limit: 1 }, { path: '/_stainless_unknown_path' }))
      .rejects
