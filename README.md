# Increase TypeScript API Library

[![NPM version](<https://img.shields.io/npm/v/increase.svg?label=npm%20(stable)>)](https://npmjs.org/package/increase) ![npm bundle size](https://img.shields.io/bundlephobia/minzip/increase)
...
1. Via the `INCREASE_LOG` environment variable
...
const client = new Increase({
  logger: logger.child({ name: 'Increase' }),
...
const client = new Increase({ fetch });
```
...
We are keen for your feedback; please open an [issue](https://www.github.com/Increase/increase-typescript/issues) with questions, bugs, or suggestions.
